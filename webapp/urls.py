...
urlpatterns = [
    ...
    path('gestione_domande' , page_views.gestione_domande, name= 'gestione_domande'),
    path('get_varianti/<int:domanda_id>', page_views.get_varianti, name='get_varianti'),
    path('add_variante/', page_views.add_variante, name='add_variante'),
    path('delete_variante/<int:variante_id>/', page_views.delete_variante, name='delete_variante'),
    path('update_domanda/<int:domanda_id>/', page_views.update_domanda, name='update_domanda'),
