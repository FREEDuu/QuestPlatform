...
urlpatterns = [
    ...
    path('creaTestCollettivoDisplay/<int:idTest>' , page_views.creaTestCollettivoDisplay, name= 'creaTestCollettivoDisplay'),
    ...
    path('testProgrammatiStart/<int:idTest>', test_common_views.TestProgrammatiStart, name = 'TestProgrammatiStart'),
