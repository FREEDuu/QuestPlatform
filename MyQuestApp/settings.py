...
ALLOWED_HOSTS = ['questplatform.fly.dev', 'localhost', '127.0.0.1', 'mousex.it', 'www.mousex.it', 'mousex.applikuapp.com']

CSRF_TRUSTED_ORIGINS = ['https://questplatform.fly.dev', 'https://mousex.it', 'https://www.mousex.it', 'https://mousex.applikuapp.com']
...
DATABASES = {
    "default": {
        ...
        "NAME": "questApplication", #questApplication #questapplicationlab
        "USER": "carl",
